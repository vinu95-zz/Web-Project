...
<!-- sign in form begins -->
  <form class="form-horizontal bg-inverse mb-3 mt-5 p-2" name="form" action="adminadduser.php" onSubmit="return validateForm();" method="POST">
<!-- Text input-->
...
<button type="submit" class="btn btn-outline-primary btn-md btn-block">Add User</button>
</div>
</div>
</form>
</div><!--col-md-6 end-->
